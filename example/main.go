...
import (
	...
	ua "github.com/gummy789j/useragent"
)
...
func main() {
	userAgents := []string{
		...
		"Mozilla/5.0 (Linux; Android 11; Pixel) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.115 Mobile Safari/537.36",
	}
